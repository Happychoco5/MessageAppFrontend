...
export class LoginService {
  ...
  getLogin(json:string){
    ...
    return this.http.post<JSON>("http://localhost:8080/login", newJSON, {responseType: 'text' as 'json', observe: 'response', headers: headers}).pipe(catchError(this.handleError));
  }
